...
a1l=32.0; b1l=32.0; c1l=1920.0; a1r=6.61; b1r=-0.661; c1r=1983.0; # Example of Grand Bay (Alizad et al., 2018; PLOS ONE)
a2l=73.8; b2l=-1.14; c2l=1587.1; a2r=a2l; b2r=b2l; c2r=c2l; # Example of Weeks Bay (Alizad et al., 2018; PLOS ONE)
a3l=197.5; b3l=-9870.0; c3l=1999.0; a3r=326.5; b3r=-1633.0; c3r=1998.0; # Example of Apalachicola Bay (Alizad et al., 2016; Earth's Future)
q=0.0018; k=0.000015; dt=5.0; # Coefficients taken from Morris et al. (2002; Ecology)
...
D[:,0]=pts[:,15]-pts[:,6]; D[D<0.0]=0.0;
B1l=a1l*D+b1l*D**2+c1l; B1l[B1l<0.0]=0.0; B1l[D>=0.0]=0.0; B1r=a1r*D+b1r*D**2+c1r; B1r[B1r<0.0]=0.0; B1r[D<0.0]=0.0; B1=B1l+B1r;
B2l=a2l*D+b2l*D**2+c2l; B2l[B2l<0.0]=0.0; B2l[D>=0.0]=0.0; B2r=a2r*D+b2r*D**2+c2r; B2r[B2r<0.0]=0.0; B2r[D<0.0]=0.0; B2=B2l+B2r;
B3l=a3l*D+b3l*D**2+c3l; B3l[B3l<0.0]=0.0; B3l[D>=0.0]=0.0; B3r=a3r*D+b3r*D**2+c3r; B3r[B3r<0.0]=0.0; B3r[D<0.0]=0.0; B3=B3l+B3r;
A1=q*D+k*B1*D; A1[D<0.0]=0.0; A2=q*D+k*B2*D; A2[D<0.0]=0.0; A3=q*D+k*B3*D; A3[D<0.0]=0.0;
