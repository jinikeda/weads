...
def hydro_classify(inputElevation, inputRaster, outputRaster, DEBUG=False):
    ...
    inunTBN[mask_water] = 2.0 # temporary set to water region and will separate to ocean (subtidal zone) and pond/lake
    inunTBN[inunTBN <= 0-accuracy] = ndv # set nodata value to -99999.0 in the domain of TBBN
    ...
    out_array[mask_outdomain] = ndv # set nodata value to -99999.0 in the domain of TBBN
