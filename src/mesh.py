...
def elementBoundingBox(elementID,myMesh,meshConn,transformer,convert):
    # Compute the bounding box of element i/Users/mvb49270/Documents/repo/pyHydroMEM/src/interpolationMethods.py
    elemX = [None]*3
    elemY = [None]*3
...
def findRasterStencil(bbox, numRows, numCols,\
    ...
    if maxRow > numRows: maxRow = numRows
    if minCol < 0: minCol = 0
    if maxCol > numCols: maxCol = numCols
