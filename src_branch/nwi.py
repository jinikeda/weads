...
def read_tif(Raster_file,spread_flag,deltaT=5):
    ...
    if spread_flag == False:
        ...
        print("\n----------------------------------------------------------------------")
        print("Step 4.: Spread vegetation nodes and make pontential expansion")
        print("----------------------------------------------------------------------\n")
...
########################################################################################################################
# internal command
# read_tif('NWI_TX_wetlands4m.tif', False,deltaT=5.0) #read_tif(Raster_file,spread_flag,deltaT=5):
