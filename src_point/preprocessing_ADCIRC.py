...
#from general_functions import *
def preprocessing_ADCIRC(inputMeshFile, inputAttrFile, inputInundationtimeFile, inputHarmonicsFile, inputShapeFile, domainIOFile, inEPSG, outEPSG):
    ...
    ########################################################################################################################
    mann, mann_indices, local_mann_indices, global_mann = read_fort13(inputAttrFile)
    ...
    ########################################################################################################################
    inundationtime, nN, max_time = read_inundationtime63(inputInundationtimeFile)
    ...
    ########################################################################################################################
    Harmonics_nodes, numHarm, nN,tidal_frequencies,tidal_constituents = read_fort53(inputHarmonicsFile)
